    ...
    <div class="page-wrapper">
        <div class="page-content">
            <div class="container">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.career_job.update', $job->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row g-3">
                                <div class="col-md-6 mb-3">
                                    <label for="title" class="form-label">Job Title <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="title" name="title" required value="{{ old('title', $job->title) }}" placeholder="e.g. Senior Biomedical Service Engineer">
                                    @error('title')
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select text-uppercase" id="career_category_id" name="career_category_id" required>
                                        ...
                                        @foreach($categories as $category)
                                            <option value="{{ $category->id }}" {{ old('career_category_id', $job->career_category_id) == $category->id ? 'selected' : '' }}>{{ $category->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="location" name="location" required value="{{ old('location', $job->location) }}" placeholder="e.g. Chennai, TN">
                                    @error('location')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="qualification" name="qualification" required value="{{ old('qualification', $job->qualification) }}" placeholder="e.g. B.E / B.Tech / Diploma in Biomedical Engineering">
                                    @error('qualification')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="experience" name="experience" required value="{{ old('experience', $job->experience) }}" placeholder="e.g. 3 to 5 Years">
                                    @error('experience')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="salary" name="salary" value="{{ old('salary', $job->salary) }}" placeholder="e.g. Competitive (Based on expertise)">
                                    @error('salary')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
