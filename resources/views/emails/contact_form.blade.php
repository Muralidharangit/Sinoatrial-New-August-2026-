                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    {{-- <tr>
                                        <td align="left"
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:12px;line-height:16px;text-align:left;color:#000;">
                                                <p><b>Message:</b> {{ $contactInfo['message'] }}</p>
                                            </div>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#000000" role="presentation"
                                                        ...
                                                        valign="middle">
                                                        <p
                                                            style="background:#000000;color:#ffffff;font-family:'Helvetica Neue',Arial,sans-serif;font-size:15px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                            <a href="#"
